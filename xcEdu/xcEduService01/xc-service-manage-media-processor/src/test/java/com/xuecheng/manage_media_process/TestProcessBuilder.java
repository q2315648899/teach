...
//        processBuilder.command("java","-jar","f:/xc-service-manage-course.jar");
    ...
    // 使用ProcessBuilder调用ffmpeg.exe将avi转成mp4
    @Test
    public void testFFmpeg() {
        ...
        command.add("-r");
        command.add("18");
        command.add("D:\\ffmpeg_test\\lucene.mp4");
    ...
    public void testProcessMp4() {
        ...
        //video_path视频地址
        String video_path = "D:\\ffmpeg_test\\lucene.avi";
        //mp4_name mp4文件名称
        String mp4_name = "lucene.mp4";
        //mp4folder_path mp4文件目录路径
        String mp4folder_path = "D:\\ffmpeg_test\\";
