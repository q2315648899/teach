...
public enum CourseCode implements ResultCode {
    ...
    COURSE_PUBLISH_CREATE_INDEX_ERROR(false,31104,"课程索引信息创建失败！"),
    COURSE_MEDIA_TEACHPLAN_ISNULL(false,31105,"要和媒资文件关联的当前计划不存在！"),
    COURSE_MEDIA_TEACHPLAN_GRADEERROR(false,31106,"只允许选择第三级的课程计划关联媒资文件！");
